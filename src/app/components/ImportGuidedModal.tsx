...
import { X, Download, Upload, CheckCircle, ArrowLeft } from 'lucide-react';
import { downloadChecklistTemplate } from '../utils/checklistTemplate';
import { toast } from 'sonner';

interface ImportGuidedModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function ImportGuidedModal({ isOpen, onClose, onFileSelect, employeeName }: ImportGuidedModalProps) {
  ...
  const handleDownloadTemplate = () => {
    downloadChecklistTemplate(employeeName);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[85vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-[#5B9BD5] to-[#4682B4] border-b p-5 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-white">Import Custom Checklist</h2>
        ...
        <div className="p-6 space-y-5">
          ...
          <div className={`border-2 rounded-lg p-4 transition-all ${
            ...
            <p className="text-sm text-gray-600 mb-3 ml-11">
              Includes: Business Process, Category, Requirement, Priority, Status, Evidence, Responsible, Target Date
            </p>
          ...
          <div className={`border-2 rounded-lg p-4 transition-all ${
            ...
            <div className="ml-11">
              <input
                ...
                className="hidden"
                id="upload-checklist-file"
              />
              <label
                htmlFor="upload-checklist-file"
